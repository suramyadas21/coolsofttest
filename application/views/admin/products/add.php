        ...
        <fieldset>
          ...
          echo '<div class="control-group">';
            ...
            echo '<div class="controls">';
              ...
              echo form_dropdown('product_type_id', $options_product_type, set_value('product_type_id'), 'class="span2"');

            echo '</div>';
          echo '</div">';
          ?>
		   <div class="control-group">
            <label for="userfile" class="control-label">Image</label>
            <div class="controls">
            <input name="upfile[]" id="userfile" type="file" multiple="multiple" />
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
