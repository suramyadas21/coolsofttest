      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_product_type = array(0 => "all");
...
height: 26px;"');
              ...
              echo form_label('Filter by product_type:', 'product_type_id');
              echo form_dropdown('product_type_id', $options_product_type, $product_type_selected, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="red header">product_type</th>
				<th class="red header">Images</th>
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td><img src='.base_url().$row['product_path'].' width=100 height=100></td>';
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/products/update/'.$row['id'].'" class="btn btn-info">spec</a>  
